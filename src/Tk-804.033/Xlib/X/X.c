...
XS_EUPXS(XS_Tk__X_constant); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Tk__X_constant)
{
    dVAR; dXSARGS;
    if (items != 2)
...
extern "C"
#endif
XS_EXTERNAL(boot_Tk__X); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Tk__X)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        (void)newXSproto_portable("Tk::X::constant", XS_Tk__X_constant, file, "$$");
#if PERL_VERSION_LE(5, 21, 5)
