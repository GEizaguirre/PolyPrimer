...
XS_EUPXS(XS_Tk_text); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Tk_text)
{
    dVAR; dXSARGS;
...
extern "C"
#endif
XS_EXTERNAL(boot_Tk__Text); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Tk__Text)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("Tk::text", XS_Tk_text);
