...
XS_EUPXS(XS_Tk__Pixmap_Install); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Tk__Pixmap_Install)
{
    dVAR; dXSARGS;
    if (items != 2)
...
extern "C"
#endif
XS_EXTERNAL(boot_Tk__Pixmap); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Tk__Pixmap)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("Tk::Pixmap::Install", XS_Tk__Pixmap_Install);
